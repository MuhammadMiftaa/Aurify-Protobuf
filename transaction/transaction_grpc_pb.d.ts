...
interface ITransactionServiceService_ICreateTransaction extends grpc.MethodDefinition<transaction_transaction_pb.NewTransaction, transaction_transaction_pb.Transaction> {
    path: "/transaction.TransactionService/CreateTransaction";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<transaction_transaction_pb.NewTransaction>;
    requestDeserialize: grpc.deserialize<transaction_transaction_pb.NewTransaction>;
    responseSerialize: grpc.serialize<transaction_transaction_pb.Transaction>;
    responseDeserialize: grpc.deserialize<transaction_transaction_pb.Transaction>;
}
